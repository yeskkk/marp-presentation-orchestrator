...
Write-Warning "Codex will run without approvals or sandboxing. Use only in an isolated environment."
...
& codex --strict-config --cd $Root --dangerously-bypass-approvals-and-sandbox --search $Prompt
exit $LASTEXITCODE
